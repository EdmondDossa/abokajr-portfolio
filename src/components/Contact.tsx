...
const Contact = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-purple-50 to-pink-50" id="contact">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-purple-600">
              ...
              <a href="mailto:marie.edmond.hegnon@gmail.com" className="hover:text-purple-700 transition-colors">
                marie.edmond.hegnon@gmail.com
              </a>
            </div>
          </div>
          <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-lg transform hover:scale-[1.02] transition-transform duration-300">
            <div>
