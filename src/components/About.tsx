const About = () => {
  return (
    <section
      className="py-20 bg-gradient-to-br from-purple-50 to-pink-50 px-8"
      id="about"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Développeur de logiciels expérimenté avec plus de 2 ans
              d'expérience dans l'industrie informatique, j'ai travaillé sur une
              large gamme de projets. Maîtrisant plusieurs langages de
              programmation et frameworks, j'ai une solide expérience dans
              l'analyse des besoins des utilisateurs, la conception de solutions
              logicielles robustes et la gestion efficace des projets de
              développement.
            </p>
          ...
          <div className="bg-gradient-to-br from-white to-purple-50 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h3 className="font-semibold text-[#6E59A5] mb-4">
              Centres d'intérêt
            </h3>
            <div className="flex flex-wrap gap-2">
              {["Théâtre", "Football", "Basketball", "Lecture", "Musique"].map(
                (interest) => (
                  <span
                    key={interest}
