...
import Image1 from '../assets/images/image_1_abj.png';
import Vscode from '../assets/images/Vscode.svg';
import Laravel from '../assets/images/laravel.svg';
import Vuejs from '../assets/images/Vuejs.svg';
import Php from '../assets/images/php.svg';
import Reactjs from '../assets/images/Reactjs.svg';
import Globe from '../assets/images/subway_world-1.svg';
    ...
    return (
        <div className="lg:flex px-10 py-10 lg:py-16 justify-between animate-slide-in" id="accueil">
            <div className="w-full lg:w-[50%] lg:px-9">
                ...
                <div className="py-2">
                    <span className="md:text-[15px] lg:text-[16px] text-[13px] text-[#666564] uppercase">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere.</span>
                </div>
